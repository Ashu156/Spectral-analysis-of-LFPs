...
%  channelID    = {'28'; '26'; '26'; '28'; '28';...
%                    '28'; '28'; '28'; '25'; '25';...
%                    '28';'28'; '01'; '29'; '29';...
%                    '26'; '28'};
               
%  channelID    = {'29'; '28'; '28'; '29'; '29';...
%                    '29'; '29'; '29'; '26';...
%                    '29'; '29'; '02'; '31'; '31';...
%                    '28'; '29'};
...
% load(strcat(fileLocation, ratID{i, 1}, '\', exptID, '\', fileID, brainArea, '_',  channelID{i, 1},  '_', nCycles, '.mat'));
end
...
tf2 = evalin('base', strcat('tf2_', ratID{4}));
    % dB converted power
    baseline_power = mean(tf2(:, baselineidx(1):baselineidx(2)), 2);
